...
All K8s state are stored in etcd. It needs to be bootstrapped for high availability and secure remote access.

You need to ssh onto each of the controller nodes
...
Install the `etcd` and `etcdctl` command line utilities
```bash
{
